    ...
    <div className='w-full'>
      ...
      <div className='flex flex-wrap gap-8 items-center'>
        <div onClick={() => setSelected('0x335301C43a5319fd890')}>
          <Card
            address='0x335301C43a5319fd890'
            balance={2.4}
            selected={selected === '0x335301C43a5319fd890' ? true : false}
          />
        </div>
        <div onClick={() => setSelected('0x335301C43a5319fd891')}>
          <Card
            address='0x335301C43a5319fd891'
            balance={1.2}
            selected={selected === '0x335301C43a5319fd891' ? true : false}
          />
        </div>
